...
def build_graph():
    ...
    # 노드 등록
    g.add_node("domain",       domain_context_node)
    g.add_node("schema_rag",   schema_rag_node)
    g.add_node("sql_gen",      sql_generator_node)
    g.add_node("sql_valid",    sql_validator_node)
    g.add_node("human_review", human_review_node)
    g.add_node("sql_exec",     sql_executor_node)
